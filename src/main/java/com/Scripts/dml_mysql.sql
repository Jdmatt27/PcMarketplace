...
ALTER TABLE clientes MODIFY COLUMN id_cliente INT AUTO_INCREMENT;
...
ALTER TABLE ventas MODIFY COLUMN id_venta INT AUTO_INCREMENT;
ALTER TABLE detalle_venta MODIFY COLUMN id_detalle INT AUTO_INCREMENT;
...
INSERT INTO ventas VALUES (1, 1, 1, '2024-01-10', 'PENDIENTE', 650.00);
INSERT INTO ventas VALUES (2, 2, 2, '2024-01-15', 'PAGADA', 150.00);
INSERT INTO ventas VALUES (3, 3, 1, '2024-02-05', 'PAGADA', 80.00);
INSERT INTO ventas VALUES (4, 4, 3, '2024-02-20', 'CANCELADA', 25.00);
INSERT INTO ventas VALUES (5, 5, 4, '2024-03-01', 'PENDIENTE', 200.00);
...
UPDATE clientes SET direccion = 'Nueva Calle 4' WHERE id_cliente = 4; -- Modifica a Pedro Sánchez
